...
![System Sequence Diagram](US_2004_SSD.svg "System Sequence Diagram")
 ...
 *In this section the team should present, if necessary, some evidencies that the implementation is according to the design.
