...
public class OpenCourseControllerTest {
...
//        }
    ...
    public void ensureWhenNotManagerFail(){
        ...
        OpenCourseController ctrl = new OpenCourseController(unauthorizedAuthz,repo );
        assertThrows(RuntimeException.class,() -> ctrl.openCourse(course));
