...
public class ExamLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "TRUE", "FALSE", "FEEDBACK", "GRADE", 
			"SECCAO", "SOLUCAO", "OPTIONS", "ACCEPTED", "MATCHING", "SINGLE_CHOICE", 
			"MULTIPLE_CHOICE", "SHORT_ANSWER", "NUMERIC", "MISSING_WORDS", "TRUE_FALSE", 
			"DECIMALS_ALLOWED", "MISSING_LEFT", "MISSING_RIGHT", "NUMERO", "PALAVRA", 
			"ASTERISCO", "HIFEN", "UNDERSCORE", "ESPACO", "PONTO_FINAL", "DOIS_PONTOS", 
